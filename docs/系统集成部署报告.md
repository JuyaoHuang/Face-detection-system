...
```
✓ 识别成功: jutao, 相似度: 0.7071 (阈值: 0.5)
✓ 识别成功: jutao, 相似度: 0.7590 (阈值: 0.5)
✓ 识别成功: jutao, 相似度: 0.7516 (阈值: 0.5)
```
...
[face_engine] Face aligned to 112x112
[face_engine] Feature extracted successfully (norm=0.0414)
[FaceEngine] Feature extracted successfully
✓ 识别成功: gg, 相似度: 0.7071 (阈值: 0.5)
...
[face_engine] Detected 1 face(s), using the first one (score=1.000)
[face_engine] Face aligned to 112x112
[face_engine] Feature extracted successfully (norm=0.0199)
[FaceEngine] Feature extracted successfully
✓ 识别成功: gg, 相似度: 0.7590 (阈值: 0.5)
[face_engine] Decoded image: 640x480
scale=0.500000 dst_box=(0 40 319 279) allow_slight_change=1 _left_offset=0 _top_offset=40 padding_w=0 padding_h=80
convert image use cpu
finish
...
[face_engine] Detected 1 face(s), using the first one (score=1.000)
[face_engine] Face aligned to 112x112
[face_engine] Feature extracted successfully (norm=0.0264)
[FaceEngine] Feature extracted successfully
✓ 识别成功: gg, 相似度: 0.7516 (阈值: 0.5)
```
